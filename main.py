...
## i added this dynamic instruction agent herer for testing





# This code is a simple example of how to use the Tavily API for web searches and Gemini model for AI responses.# It demonstrates how to set up an agent that can perform deep searches and respond to user queries.# The agent can handle multiple queries, synthesize information from various sources, and provide comprehensive answers.

# """""
 # 
#    question = input("write a question for the agents: ")
    
#     print("Cold Agent (low temperature):")
...
#         model_settings=ModelSettings(temperature=0.1, max_tokens=1000),  # here in this part i set the temratuire and tokkens this is also called model settings
#         model=model
...
#     agent_search = Agent(
#         name="Search Agent",
#         instructions="You are a helpful assistant that can search the web for information. and give summarized results.",
#         model_settings=ModelSettings(temperature=0.5, max_tokens=1000),  # Moderate temperature for balanced responses
#         model=model,
#         tools=[tavily_web_search]  # Use the new Tavily tool here
#     )

#     search_question = input("Write a question that requires a web search: ")
#     print("Search Agent (using Tavily):")
#     result_search = await Runner.run(agent_search, search_question)
#     print(result_search.final_output)
...
# 🔍 New tool that uses the Tavily API to perform a web search
#     print("\n💡 Notice: The agent will decide when to use the web search tool to answer your question.")    
# """"
